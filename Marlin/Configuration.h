...
#define STRING_CONFIG_H_AUTHOR "Jason Theriault (5/20/2024)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3-PRO (5/21/24)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -15, -2.85 }
