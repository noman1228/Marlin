...
#define STRING_CONFIG_H_AUTHOR "Jason Theriault 5-21-2024)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NEO (5/22/24)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -10, -2.75 }
